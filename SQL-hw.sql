...
#SELECT actor_id, first_name, last_name FROM actor WHERE (first_name='HARPO' or first_name='GROUCHO') AND last_name='WILLIAMS';
...
SELECT film.title, COUNT(film.title) AS 'Copies' 
FROM film
...
SELECT f.title, COUNT(f.film_id) AS 'Times Rented'
FROM film_text AS f
